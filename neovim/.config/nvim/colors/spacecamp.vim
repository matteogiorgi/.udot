"" spacecamp.vim - vim color scheme
"""""""""""""""""""""""""""""""""""

"" written by Jared Gorski (https://jaredgorski.org/)
...
let s:spaceBlack3 = {'gui': '#000000', 'cterm256': '251'}
...
"" Definitions `call <sid>hi(GROUP, FOREGROUND, BACKGROUND, ATTRIBUTE)`
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

" Editor
call <sid>hi('ColorColumn', s:none, s:spaceBlack, 'none')
call <sid>hi('Cursor', s:spaceBlack, s:spaceSteel, 'none')
call <sid>hi('CursorColumn', s:none, s:spaceBlack, 'none')
call <sid>hi('CursorLine', s:none, s:spaceBlack, 'none')
call <sid>hi('CursorLineNr', s:spaceSteel, s:none, 'bold')
...
call <sid>hi('Normal', s:spaceWhite, s:spaceBlack3, 'none')
...
call <sid>hi('SignColumn', s:none, s:spaceBlack3, 'bold')
call <sid>hi('StatusLine', s:spaceSteel, s:spaceGray1, 'bold')
call <sid>hi('StatusLineNC', s:spaceGray3, s:spaceGray1, 'bold')
call <sid>hi('VertSplit', s:spaceGray1, s:none, 'none')
call <sid>hi('Visual', s:none, s:spaceGray2, 'none')
call <sid>hi('TabLine', s:spaceSteel, s:spaceGray1, 'bold')
call <sid>hi('TabLineFill', s:spaceGray3, s:spaceGray1, 'bold')
...
call <sid>hi('NonText', s:spaceGray1, s:spaceBlack3, 'none')
