...
call <sid>X('ColorColumn',  '',              s:almost_bg,      '')
...
call <sid>X('VertSplit',    s:vertsplit,     s:syntax_bg,      'none')
...
call <sid>X('PMenuSbar',    '',              s:vertsplit,      '')
...
call <sid>X('StatusLine',   s:syntax_fg,     s:vertsplit,      'bold')
call <sid>X('StatusLineNC', s:mono_3,        s:vertsplit,      'none')
call <sid>X('TabLine',      s:mono_2,        s:vertsplit,      'none')
call <sid>X('TabLineFill',  s:mono_3,        s:vertsplit,      'none')
call <sid>X('TabLineSel',   s:hue_2,         s:vertsplit,      'bold')
