...
```
i3-wm xautolock arandr kitty xterm tmux kak helix sxiv bash bash-completion
...
brave chromium simplescreenrecorder transmission vlc mypaint slides vim-gtk3
```
