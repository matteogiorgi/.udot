...
flameshot diodon pavucontrol volumeicon-alsa gparted chrome-gnome-shell input-remapper
cups system-config-printer gnome-shell-extension-prefs bash bash-completion
```
