...
" Declare theme name and variables
...
" level for the given color index
fun <SID>rgb_level(n)
    if &t_Co == 88
        if a:n == 0
            return 0
...
" Returns the palette index
" for the given R/G/B color indices
...
" Rreturns the palette index toapproximate
" the given R/G/B color levels
fun <SID>color(r, g, b)
...
" Highlight function
" (borrowed from mhartington/oceanic-next)
...
call <sid>X('ColorColumn',  '',              s:hue_5,          '')
call <sid>X('Conceal',      s:mono_4,        s:syntax_bg,      '')
call <sid>X('Cursor',       '',              s:syntax_accent,  '')
call <sid>X('CursorIM',     '',              '',               '')
call <sid>X('CursorColumn', '',              s:almost_bg,      '')
call <sid>X('CursorLine',   '',              s:almost_bg,      'none')
call <sid>X('Directory',    s:hue_2,         '',               '')
call <sid>X('ErrorMsg',     s:hue_5,         s:syntax_bg,      'none')
call <sid>X('VertSplit',    s:syntax_cursor, s:syntax_bg,      'none')
...
call <sid>X('CursorLineNr', s:syntax_fg,     s:syntax_bg,      'bold')
...
call <sid>X('StatusLine',   s:syntax_fg,     s:almost_bg,      'bold')
call <sid>X('StatusLineNC', s:mono_3,        s:almost_bg,      'none')
call <sid>X('TabLine',      s:mono_2,        s:almost_bg,      'none')
call <sid>X('TabLineFill',  s:mono_3,        s:almost_bg,      'none')
call <sid>X('TabLineSel',   s:hue_2,         s:almost_bg,      'bold')
