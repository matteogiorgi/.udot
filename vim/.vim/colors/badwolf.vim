...
if !has("gui_running") && &t_Co != 88 && &t_Co != 256 | finish | endif
if !exists("g:badwolf_html_link_underline") | let g:badwolf_html_link_underline = 1 | endif
if !exists("g:badwolf_css_props_highlight") | let g:badwolf_css_props_highlight = 0 | endif
" }}}
...
" Args: group, guifg, guibg, gui, guisp
...
call s:HL('CursorLineNR', ''            , 'darkgravel', 'bold'     )
